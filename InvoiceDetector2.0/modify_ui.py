...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(465, 483)
        self.buttonBox = QDialogButtonBox(Dialog)
        self.buttonBox.setObjectName(u"buttonBox")
        self.buttonBox.setGeometry(QRect(100, 430, 341, 32))
        ...
        self.label_invoice_code_mod = QLabel(self.frame_INFO)
        self.label_invoice_code_mod.setObjectName(u"label_invoice_code_mod")
        self.label_invoice_code_mod.setGeometry(QRect(20, 30, 81, 21))
        self.label_invoice_code_mod.setStyleSheet(u"font: 12pt \"Microsoft YaHei UI\";")
        ...
        self.textEdit_code_mod = QTextEdit(self.frame_INFO)
        self.textEdit_code_mod.setObjectName(u"textEdit_code_mod")
        self.textEdit_code_mod.setGeometry(QRect(100, 30, 251, 31))
        self.textEdit__buyername_mod = QTextEdit(self.frame_INFO)
        self.textEdit__buyername_mod.setObjectName(u"textEdit__buyername_mod")
        self.textEdit__buyername_mod.setGeometry(QRect(100, 110, 251, 31))
        self.textEdit_buyercode_mod = QTextEdit(self.frame_INFO)
        self.textEdit_buyercode_mod.setObjectName(u"textEdit_buyercode_mod")
        self.textEdit_buyercode_mod.setGeometry(QRect(100, 150, 251, 31))
        self.textEdit_sellername_mod = QTextEdit(self.frame_INFO)
        self.textEdit_sellername_mod.setObjectName(u"textEdit_sellername_mod")
        self.textEdit_sellername_mod.setGeometry(QRect(100, 190, 251, 31))
        self.textEdit_sellercode_mod = QTextEdit(self.frame_INFO)
        self.textEdit_sellercode_mod.setObjectName(u"textEdit_sellercode_mod")
        self.textEdit_sellercode_mod.setGeometry(QRect(100, 230, 251, 31))
        ...
        self.textEdit_note_mod = QTextEdit(self.frame_INFO)
        self.textEdit_note_mod.setObjectName(u"textEdit_note_mod")
        self.textEdit_note_mod.setGeometry(QRect(100, 310, 251, 81))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Modify", None))
        self.label_invoice_code_mod.setText(QCoreApplication.translate("Dialog", u"\u53d1\u7968\u4ee3\u7801\uff1a", None))
        ...
        self.label_Adding_2.setText(QCoreApplication.translate("Dialog", u"Modify an Invoice", None))
    # retranslateUi
